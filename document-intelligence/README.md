...
| Function | Purpose | Max Size | Max Pages | Output | Docs |
|----------|---------|----------|-----------|--------|------|
| [`AI_EXTRACT`](https://docs.snowflake.com/en/user-guide/snowflake-cortex/ai-documents) | Structured field/table extraction | 100 MB | 125 | JSON | [Link](https://docs.snowflake.com/en/user-guide/snowflake-cortex/ai-documents) |
| `AI_PARSE_DOCUMENT` | Full content parsing | 50 MB | 500 | Markdown | [Link](https://docs.snowflake.com/en/user-guide/snowflake-cortex/parse-document) |
